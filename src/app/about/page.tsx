...
function SocialMedia() {
  return (
    <ul role="list">
      <SocialMediaItem href="https://instagram.com/" className="mt-4">
        <InstagramIcon className="fill-muted-foreground size-6 group-hover:fill-teal-500" />
        Follow on Instagram
      </SocialMediaItem>
      <SocialMediaItem href="https://github.com/" className="mt-4">
        <GitHubIcon className="fill-muted-foreground size-6 group-hover:fill-teal-500" />
        Follow on Github
      </SocialMediaItem>
      <SocialMediaItem href="https://facebook.com/" className="mt-4">
        <FacebookIcon className="fill-muted-foreground size-6 group-hover:fill-teal-500" />
        Follow on Facebook
      </SocialMediaItem>
      <SocialMediaItem href="https://dribbble.com/" className="mt-4">
        <DribbbleIcon className="fill-muted-foreground size-6 group-hover:fill-teal-500" />
        Follow on Dribbble
      </SocialMediaItem>
    </ul>
  );
      ...
      <Container>
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            <div className="text-muted-foreground mt-6 space-y-7 text-base">
              <p>
