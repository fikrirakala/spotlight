<Section title="Tech Stack">
  <SectionEntry title="React">
    The library for web and native user interfaces.
  </SectionEntry>
  <SectionEntry title="Next.js">
  ...
  <SectionEntry title="Tailwind CSS">
  ...
  <SectionEntry title="Lucide Icons">
